...
## STEP 1
```sh
└─$ rustscan -a 10.129.228.98  --no-banner --scripts none
...
```sh
└─$ wget -nv https://raw.githubusercontent.com/nikn0laty/PDFkit-CMD-Injection-CVE-2022-25765/refs/heads/main/CVE-2022-25765.py
2025-07-02 08:53:49 URL:https://raw.githubusercontent.com/nikn0laty/PDFkit-CMD-Injection-CVE-2022-25765/refs/heads/main/CVE-2022-25765.py [1582/1582] -> "CVE-2022-25765.py" [1]
...
```
が、Ruby3.1以前は`YAML.load()`でyamlを読み込むとReserializationしてそこからコマンド実行の脆弱性があるらしい  
